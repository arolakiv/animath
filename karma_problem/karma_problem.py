...
class Bitruncated(ThreeDScene):
    ...
    def drawHexagons(self):
        ...
        self.sectors[0].add(hexagon)
        self.sectors[0].add(sideXY)
        self.sectors[0].add(sideYZ)
        self.sectors[0].add(sideZX)
        self.sectors[0].add(smallXY)
        self.sectors[0].add(smallYZ)
        self.sectors[0].add(smallZX)
        ...
        for i in range(1, 8): #all 8 coordinates except the 1st one
            ...
            self.sectors[i].add(hexagon)
            self.sectors[i].add(sideXY)
            self.sectors[i].add(sideYZ)
            self.sectors[i].add(sideZX)
            self.sectors[i].add(smallXY)
            self.sectors[i].add(smallYZ)
            self.sectors[i].add(smallZX)
...
class Truncation(ThreeDScene):
    def init(self):
        ...
        self.object = VGroup(hexagon, sideXY, sideYZ, sideZX, smallXY, smallYZ, smallZX)
    ...
    def threePyramid(self):
        ...
        pyraXY = VGroup(
        Polygon(np.array([1, 1, -1]), np.array([1, 0, -1]), np.array([1, 1, -2])),
        Polygon(np.array([1, 1, -1]), np.array([1, 1, -2]), np.array([0, 1, -1])),
        Polygon(np.array([1, 1, -1]), np.array([0, 1, -1]), np.array([1, 0, -1])),
        Polygon(np.array([0, 1, -1]), np.array([1, 0, -1]), np.array([1, 1, -2]))
        )

        pyraYZ = VGroup(
        Polygon(np.array([-1, 1, 1]), np.array([-1, 1, 0]), np.array([-2, 1, 1])),
        Polygon(np.array([-1, 1, 1]), np.array([-2, 1, 1]), np.array([-1, 0, 1])),
        Polygon(np.array([-1, 1, 1]), np.array([-1, 0, 1]), np.array([-1, 1, 0])),
        Polygon(np.array([-1, 0, 1]), np.array([-1, 1, 0]), np.array([-2, 1, 1]))
        )

        pyraZX = VGroup(
        Polygon(np.array([1, -1, 1]), np.array([0, -1, 1]), np.array([1, -1, 0])),
        Polygon(np.array([1, -1, 1]), np.array([1, -2, 1]), np.array([0, -1, 1])),
        Polygon(np.array([1, -1, 1]), np.array([1, -1, 0]), np.array([1, -2, 1])),
        Polygon(np.array([1, -1, 0]), np.array([0, -1, 1]), np.array([1, -2, 1]))
        )
